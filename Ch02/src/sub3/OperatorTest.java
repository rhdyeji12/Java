...
public class OperatorTest {
     public static void main(String[] args) {
    	...
    	System.out.println("result5 : "+ result5);
         ...
         System.out.println("rs4 : " + rs4); // var1이 var2보다 작거나 같다.
         System.out.println("rs5 : " + rs5); // var1이 var2보다 서로 같다.
         System.out.println("rs6 : " + rs6); // var1이 var2보다 서로 다르다.
         ...
         boolean res5 = !(var3 > var4)&& (var4 > 3 );  // var3은 var4보다 크지않다.
